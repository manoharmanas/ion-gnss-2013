...
\section*{Previous Work}
  ...
  % DRTK
  DRTK is a feature now common on many GPS receivers, with
...
\section*{Graphical User Interface}
  ...
  To determine whether these values are acceptable, the user
  % 
  ...
  \subsection*{Qt}
    ...
    Since the relative path is computed in ECEF coordinates and converted into relative ENU components
