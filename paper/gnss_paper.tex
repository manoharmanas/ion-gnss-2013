...
\section*{Experimentation}
  ...
  \subsection*{Precision Following Test}
    ...
    \begin{figure}[ht] \centering
      ...
      \caption{Probability density estimate function for lateral deviation during the best run of the precision following test}
  ...
  \subsection*{Zero-Landmark Test}
    ...
    \begin{figure}[ht] \centering
      ...
      \caption{Probability density estimate function for lateral deviation during the best run of the zero landmark test}
