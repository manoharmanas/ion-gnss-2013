...
\begin{tikzpicture}[
    ...
    \begin{scriptsize}
        % cones
        \fill [color=ffzzqq] (4,12)     circle (8.0pt);
        \fill [color=ffzzqq] (6,12)     circle (8.0pt);
        \fill [color=ffzzqq] (8,12)     circle (8.0pt);
        \fill [color=ffzzqq] (10,12)    circle (8.0pt);
        \fill [color=ffzzqq] (12,12)    circle (8.0pt);
        \fill [color=ffzzqq] (14,12)    circle (8.0pt);
        % leader
